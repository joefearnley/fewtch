        ...
        <style>
            ...
            @layer theme {
                ...
                :host {
                    ...
                    --color-jule-50: oklch(.977 .013 236.62);
                    --color-jule-100: oklch(.951 .026 236.824);
                    --color-jule-200: oklch(.901 .058 230.902);
                    --color-jule-300: oklch(.828 .111 230.318);
                    --color-jule-400: oklch(.746 .16 232.661);
                    --color-jule-500: oklch(.685 .169 237.323);
                    --color-jule-600: oklch(.588 .158 241.966);
                    --color-jule-700: oklch(.5 .134 242.749);
                    --color-jule-800: oklch(.443 .11 240.79);
                    --color-jule-900: oklch(.391 .09 240.876);
                    --color-jule-950: oklch(.293 .066 243.157);
                    --color-jule-50: oklch(.97 .014 254.604);
                    --color-jule-100: oklch(.932 .032 255.585);
                    --color-jule-200: oklch(.882 .059 254.128);
                    --color-jule-300: oklch(.809 .105 251.813);
                    --color-jule-400: oklch(.707 .165 254.624);
                    --color-jule-500: oklch(.623 .214 259.815);
                    --color-jule-600: oklch(.546 .245 262.881);
                    --color-jule-700: oklch(.488 .243 264.376);
                    --color-jule-800: oklch(.424 .199 265.638);
                    --color-jule-900: oklch(.379 .146 265.522);
                    --color-jule-950: oklch(.282 .091 267.935);
