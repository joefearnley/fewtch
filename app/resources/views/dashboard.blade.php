                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-sm border-b border-gray-100 p-4 text-gray-500 dark:border-gray-700 dark:text-gray-400">
                            <div class="flex">
                                <a href="{{ route('messages.edit', $message->id) }}" class="text-jule-600 hover:underline dark:text-jule-400" title="{{ __('Edit Message') }}">
                                ...
                                <form action="{{ route('messages.destroy', $message->id) }}" method="POST" class="text-red-500 hover:underline ml-4">
